        ...
        <div className="choose__grid container grid">
            ...
            <div className="choose__details grid">
                ...
                <div className="choose__detalis-item">
                    ...
                    <div>
                        <h3 className="choose__deails-title">Pure Grades</h3>
                        <p className="choose__details-description">
                            There are many variations of passages of
                            Lorem Ipsum available
                            but the majority have suffered alteration in
                ...
                <div className="choose__detalis-item">
                    ...
                    <div>
                        <h3 className="choose__deails-title">Healthy Coffee</h3>
                        <p className="choose__details-description">
                            There are many variations of passages of
                            Lorem Ipsum available
                            but the majority have suffered alteration in
